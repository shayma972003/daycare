...
export const settingsFormSchema = z.object({
  ...
  weeklyStudentFee: optionalMoney,
  monthlyStudentFee: optionalMoney,
  yearlyStudentFee: optionalMoney,
  // "HH:mm" as produced by `<input type="time">`.
  teacherMorningCheckinTime: z.string().optional().nullable(),
  teacherMorningCheckoutTime: z.string().optional().nullable(),
  teacherEveningCheckinTime: z.string().optional().nullable(),
  teacherEveningCheckoutTime: z.string().optional().nullable(),
  studentMorningCheckinTime: z.string().optional().nullable(),
  studentMorningCheckoutTime: z.string().optional().nullable(),
  studentEveningCheckinTime: z.string().optional().nullable(),
  studentEveningCheckoutTime: z.string().optional().nullable(),
